...
TTS_SERVICE_URL = os.getenv(
    "TTS_SERVICE_URL",
    "http://127.0.0.1:8004/api/tts/speak-one"
)
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://nlp-internship-tasks-wgql-git-main-tech-5fac.vercel.app",
        "https://nlp-internship-tasks-wgql-h6qz9i3f3-tech-5fac.vercel.app",
    ],
